...
class DraftNbsSurveyAdapter(val context:Context, private var list: List<DraftNbsCommonAnswer>, var clickListener: ClickListener) :
    RecyclerView.Adapter<DraftNbsSurveyAdapter.ViewHolder>() {
