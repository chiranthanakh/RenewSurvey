...
import com.renew.globalsurvey.adapter.QuestionGroupAdapter
import com.renew.globalsurvey.databinding.ActivityFormsDetailsBinding
...
import com.renew.globalsurvey.views.fragments.CommonQuestionFragment
import com.renew.globalsurvey.views.fragments.QuestionsFragment
...
class FormsDetailsActivity : BaseActivity() ,QuestionGroupAdapter.ClickListener,
    ...
    fun validateCommonQuestions():Boolean{
        ...
        if (commonAnswersEntity.do_you_have_ration_or_aadhar ==""){
            UtilMethods.showToast(this,"Please select ration/aadhar if you have")
            return false
        }
